...
import 'package:sudict/modules/ui_comps/third/animated_visibility/transitions/enter_transition.dart';
import 'package:sudict/modules/ui_comps/third/animated_visibility/transitions/exit_transition.dart';
import 'package:sudict/modules/ui_comps/third/animated_visibility/transitions/transition_data.dart';
...
class AnimatedTransition extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return DualTransitionBuilder(
      ...
      forwardBuilder: (
        ...
        return _build(context, child, animation, enterTransition.data) ?? const SizedBox.shrink();
      },
      reverseBuilder: (
        BuildContext context,
        Animation<double> animation,
        ...
        return _build(context, child, animation, exitTransition.data) ?? const SizedBox.shrink();
      },
      child: child,
    );
  }
  ...
  Widget? _build(
      BuildContext context, Widget? child, Animation<double> animation, TransitionData data) {
